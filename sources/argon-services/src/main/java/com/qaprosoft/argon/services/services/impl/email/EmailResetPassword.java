...
public class EmailResetPassword implements IEmailMessage
{

	private static final String TEMPLATE = "email_reset_password.ftl";
	...
	public EmailResetPassword(User user, String subject, String message, String url)
	{
