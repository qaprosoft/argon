...
public class UserDAOTest extends AbstractTestNGSpringContextTests
{
	...
	{
		USER.setStatus(statusDAO.getStatusByStatus(StatusType.OFFLINE));
	...
	private void checkUser(User user)
	{
		...
		assertEquals(user.getStatus().getStatus(), USER.getStatus().getStatus(), "User's status is not as expected.");
