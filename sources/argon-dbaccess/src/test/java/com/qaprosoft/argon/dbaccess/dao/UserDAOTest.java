...
public class UserDAOTest extends AbstractTestNGSpringContextTests
{
	...
	public void createUser()
	{
		...
		USER.setAuthorities(Arrays.asList(authorityDAO.getAuthorityByAuthority(AuthorityType.USER)));
	...
	{
		Authority userAuthority = authorityDAO.getAuthorityByAuthority(AuthorityType.USER);
		Authority adminAuthority = authorityDAO.getAuthorityByAuthority(AuthorityType.ADMIN);
